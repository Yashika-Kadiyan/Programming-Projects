...
def reset():
    ...
    textmasaladosa.config(state=DISABLED)
    textsamosa.config(state=DISABLED)
    textshahipaneer.config(state=DISABLED)
    textpaavbhaaji.config(state=DISABLED)
    textcholekulcha.config(state=DISABLED)
...
def send():
    if textReceipt.get(1.0,END)=='\n':
        ...
        label=Label(root2,image=logoImage,bg='Green')
        label.pack(pady=5)

        numberLabel=Label(root2,text='Mobile Number',font=('arial',18,'bold underline'),bg='Green',fg='white')
        numberLabel.pack(pady=5)

        numberfield=Entry(root2,font=('helvetica',22,'bold'),bd=3,width=24)
        numberfield.pack(pady=5)

        billLabel = Label(root2, text='Bill Details', font=('arial', 18, 'bold underline'), bg='Green', fg='white')
        ...
        sendButton=Button(root2,text='SEND',font=('arial',19,'bold'),bg='white',fg='Green',bd=7,relief=GROOVE
                          ,command=send_msg)
...
def receipt():
    ...
    if costoffoodvar.get() != '' or costofcakesvar.get() != '' or costofdrinksvar.get() != '':
        ...
        textReceipt.insert(END,'*********************\n')
        if e_naan.get()!='0':
            textReceipt.insert(END,f'Naan\t\t\t{int(e_naan.get())*10}\n\n')

        if e_dalmakhani.get()!='0':
            textReceipt.insert(END,f'Dal Makhani\t\t\t{int(e_dalmakhani.get())*60}\n\n')

        if e_masaladosa.get()!='0':
            textReceipt.insert(END,f'Masala Dosa\t\t\t{int(e_masaladosa.get())*100}\n\n')

        if e_rice.get() != '0':
            textReceipt.insert(END, f'Rice:\t\t\t{int(e_rice.get()) * 30}\n\n')

        if e_mixveg.get() != '0':
            textReceipt.insert(END, f'Mix Veg:\t\t\t{int(e_mixveg.get()) * 50}\n\n')

        if e_shahipaneer.get() != '0':
            textReceipt.insert(END, f'Shahi Paneer:\t\t\t{int(e_shahipaneer.get()) * 100}\n\n')

        if e_samosa.get() != '0':
            textReceipt.insert(END, f'Samosa:\t\t\t{int(e_samosa.get()) * 40}\n\n')

        if e_paavbhaaji.get() != '0':
            textReceipt.insert(END, f'Paav Bhaaji:\t\t\t{int(e_paavbhaaji.get()) * 120}\n\n')

        if e_cholekulcha.get() != '0':
            textReceipt.insert(END, f'Chole Kulcha:\t\t\t{int(e_cholekulcha.get()) * 120}\n\n')
        ...
        if e_soup.get() != '0':
            textReceipt.insert(END, f'Soup:\t\t\t{int(e_soup.get()) * 80}\n\n')
        ...
        if e_butterscotch.get() != '0':
            textReceipt.insert(END, f'Butter Scotch:\t\t\t{int(e_butterscotch.get()) * 550}\n\n')
...
def totalcost():
    ...
    if var1.get() != 0 or var2.get() != 0 or var3.get() != 0 or var4.get() != 0 or var5.get() != 0 or \
        ...
        item1=int(e_naan.get())
        item2=int(e_dalmakhani.get())
        item3=int(e_masaladosa.get())
        item4 = int(e_mixveg.get())
        item5 = int(e_samosa.get())
        item6 = int(e_rice.get())
        item7 = int(e_cholekulcha.get())
        item8 = int(e_shahipaneer.get())
        item9 = int(e_paavbhaaji.get())

        item10 = int(e_lassi.get())
        item11 = int(e_coffee.get())
        item12 = int(e_soup.get())
...
def masaladosa():
    if var3.get()==1:
        textmasaladosa.config(state=NORMAL)
        textmasaladosa.delete(0,END)
        textmasaladosa.focus()
...
def cholekulcha():
    if var7.get() == 1:
        textcholekulcha.config(state=NORMAL)
        textcholekulcha.focus()
        textcholekulcha.delete(0, END)
    elif var7.get() == 0:
        textcholekulcha.config(state=DISABLED)
        e_cholekulcha.set('0')
...
def shahipaneer():
    if var8.get() == 1:
        textshahipaneer.config(state=NORMAL)
        textshahipaneer.focus()
        textshahipaneer.delete(0, END)
    elif var8.get() == 0:
        textshahipaneer.config(state=DISABLED)
        e_shahipaneer.set('0')
...
def paavbhaaji():
    if var9.get() == 1:
        textpaavbhaaji.config(state=NORMAL)
        textpaavbhaaji.focus()
        textpaavbhaaji.delete(0, END)
    elif var9.get() == 0:
        textpaavbhaaji.config(state=DISABLED)
        e_paavbhaaji.set('0')
...
root.title('Restaurant Management System created by Yashika')
...
menuFrame=Frame(root,bd=10,relief=RIDGE,bg='Green')
menuFrame.pack(side=LEFT)

costFrame=Frame(menuFrame,bd=4,relief=RIDGE,bg='Green',pady=10)
...
rightFrame=Frame(root,bd=15,relief=RIDGE,bg='Green')
rightFrame.pack(side=RIGHT)

calculatorFrame=Frame(rightFrame,bd=1,relief=RIDGE,bg='Green')
calculatorFrame.pack()

recieptFrame=Frame(rightFrame,bd=4,relief=RIDGE,bg='Green')
recieptFrame.pack()

buttonFrame=Frame(rightFrame,bd=3,relief=RIDGE,bg='Green')
buttonFrame.pack()
...
e_cholekulcha = StringVar()
e_samosa = StringVar()
e_paavbhaaji = StringVar()
...
naan=Checkbutton(foodFrame,text='Naan',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var1
                 ,command=naan)
naan.grid(row=0,column=0,sticky=W)

dalmakhani=Checkbutton(foodFrame,text='Dal Makhani',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var2
                 ,command=dalmakhani)
dalmakhani.grid(row=1,column=0,sticky=W)

masaladosa=Checkbutton(foodFrame,text='Masala Dosa',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var3
                 ,command=masaladosa)
masaladosa.grid(row=2,column=0,sticky=W)

mixveg=Checkbutton(foodFrame,text='Mix Veg',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var4
                  ,command=mixveg)
mixveg.grid(row=3,column=0,sticky=W)

samosa=Checkbutton(foodFrame,text='Samosa',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var5
                  ,command=samosa)
...
cholekulcha=Checkbutton(foodFrame,text='Chole Kulcha',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var7,
                   command=cholekulcha)
cholekulcha.grid(row=6,column=0,sticky=W)

shahipaneer=Checkbutton(foodFrame,text='Shahi Paneer',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var8
                   ,command=shahipaneer)
shahipaneer.grid(row=7,column=0,sticky=W)

paavbhaaji=Checkbutton(foodFrame,text='Paav Bhaaji',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var9
                    ,command=paavbhaaji)
paavbhaaji.grid(row=8,column=0,sticky=W)

#Entry Fields for Food Items

textnaan=Entry(foodFrame,font=('arial',18,'bold'),bd=7,width=6,state=DISABLED,textvariable=e_naan)
textnaan.grid(row=0,column=1)

textdalmakhani=Entry(foodFrame,font=('arial',18,'bold'),bd=7,width=6,state=DISABLED,textvariable=e_dalmakhani)
textdalmakhani.grid(row=1,column=1)

textmasaladosa=Entry(foodFrame,font=('arial',18,'bold'),bd=7,width=6,state=DISABLED,textvariable=e_masaladosa)
textmasaladosa.grid(row=2,column=1)

textmixveg = Entry(foodFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED, textvariable=e_mixveg)
textmixveg.grid(row=3, column=1)

textsamosa = Entry(foodFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED, textvariable=e_samosa)
textsamosa.grid(row=4, column=1)

textrice = Entry(foodFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED, textvariable=e_rice)
textrice.grid(row=5, column=1)

textcholekulcha = Entry(foodFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED, textvariable=e_cholekulcha)
textcholekulcha.grid(row=6, column=1)

textshahipaneer = Entry(foodFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED, textvariable=e_shahipaneer)
textshahipaneer.grid(row=7, column=1)

textpaavbhaaji = Entry(foodFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED, textvariable=e_paavbhaaji)
textpaavbhaaji.grid(row=8, column=1)
...
soup=Checkbutton(drinksFrame,text='Soup',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var12
                   ,command=soup)
soup.grid(row=2,column=0,sticky=W)
...
textsoup = Entry(drinksFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED, textvariable=e_soup)
textsoup.grid(row=2, column=1)
...
butterscotchcake=Checkbutton(cakesFrame,text='Butter Scotch',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var27
                            ,command=butterscotch)
butterscotchcake.grid(row=8,column=0,sticky=W)
...
textbutterscotch.grid(row=8, column=1)

#costlabels & entry fields

labelCostofFood=Label(costFrame,text='Cost of Food',font=('arial',16,'bold'),bg='Green',fg='white')
...
labelCostofDrinks=Label(costFrame,text='Cost of Drinks',font=('arial',16,'bold'),bg='Green',fg='white')
...
labelCostofCakes=Label(costFrame,text='Cost of Cakes',font=('arial',16,'bold'),bg='Green',fg='white')
...
labelSubTotal=Label(costFrame,text='Sub Total',font=('arial',16,'bold'),bg='Green',fg='white')
labelSubTotal.grid(row=0,column=2)

textSubTotal=Entry(costFrame,font=('arial',16,'bold'),bd=6,width=14,state='readonly',textvariable=subtotalvar)
textSubTotal.grid(row=0,column=3,padx=41)

labelServiceTax=Label(costFrame,text='Service Tax',font=('arial',16,'bold'),bg='Green',fg='white')
...
labelTotalCost=Label(costFrame,text='Total Cost',font=('arial',16,'bold'),bg='Green',fg='white')
...
buttonTotal=Button(buttonFrame,text='Total',font=('arial',14,'bold'),fg='white',bg='Green',bd=3,padx=5,
                   command=totalcost)
buttonTotal.grid(row=0,column=0)

buttonReceipt=Button(buttonFrame,text='Receipt',font=('arial',14,'bold'),fg='white',bg='Green',bd=3,padx=5
                     ,command=receipt)
buttonReceipt.grid(row=0,column=1)

buttonSave=Button(buttonFrame,text='Save',font=('arial',14,'bold'),fg='white',bg='Green',bd=3,padx=5
                  ,command=save)
buttonSave.grid(row=0,column=2)



buttonReset=Button(buttonFrame,text='Reset',font=('arial',14,'bold'),fg='white',bg='Green',bd=3,padx=5,
                   command=reset)
...
button7=Button(calculatorFrame,text='7',font=('arial',16,'bold'),fg='yellow',bg='Green',bd=6,width=6,
               command=lambda:buttonClick('7'))
button7.grid(row=1,column=0)

button8=Button(calculatorFrame,text='8',font=('arial',16,'bold'),fg='yellow',bg='Green',bd=6,width=6,
               command=lambda:buttonClick('8'))
button8.grid(row=1,column=1)

button9=Button(calculatorFrame,text='9',font=('arial',16,'bold'),fg='yellow',bg='Green',bd=6,width=6
               ,command=lambda:buttonClick('9'))
button9.grid(row=1,column=2)

buttonPlus=Button(calculatorFrame,text='+',font=('arial',16,'bold'),fg='yellow',bg='Green',bd=6,width=6
                  ,command=lambda:buttonClick('+'))
buttonPlus.grid(row=1,column=3)

button4=Button(calculatorFrame,text='4',font=('arial',16,'bold'),fg='yellow',bg='Green',bd=6,width=6
               ,command=lambda:buttonClick('4'))
button4.grid(row=2,column=0)

button5=Button(calculatorFrame,text='5',font=('arial',16,'bold'),fg='Green',bg='white',bd=6,width=6
               ,command=lambda:buttonClick('5'))
button5.grid(row=2,column=1)

button6=Button(calculatorFrame,text='6',font=('arial',16,'bold'),fg='Green',bg='white',bd=6,width=6
               ,command=lambda:buttonClick('6'))
button6.grid(row=2,column=2)

buttonMinus=Button(calculatorFrame,text='-',font=('arial',16,'bold'),fg='yellow',bg='Green',bd=6,width=6
                   ,command=lambda:buttonClick('-'))
buttonMinus.grid(row=2,column=3)

button1=Button(calculatorFrame,text='1',font=('arial',16,'bold'),fg='yellow',bg='Green',bd=6,width=6
               ,command=lambda:buttonClick('1'))
button1.grid(row=3,column=0)

button2=Button(calculatorFrame,text='2',font=('arial',16,'bold'),fg='Green',bg='white',bd=6,width=6
               ,command=lambda:buttonClick('2'))
button2.grid(row=3,column=1)

button3=Button(calculatorFrame,text='3',font=('arial',16,'bold'),fg='Green',bg='white',bd=6,width=6
               ,command=lambda:buttonClick('3'))
button3.grid(row=3,column=2)

buttonMult=Button(calculatorFrame,text='*',font=('arial',16,'bold'),fg='yellow',bg='Green',bd=6,width=6
                  ,command=lambda:buttonClick('*'))
buttonMult.grid(row=3,column=3)

buttonAns=Button(calculatorFrame,text='Ans',font=('arial',16,'bold'),fg='yellow',bg='Green',bd=6,width=6,
                 command=answer)
buttonAns.grid(row=4,column=0)

buttonClear=Button(calculatorFrame,text='Clear',font=('arial',16,'bold'),fg='yellow',bg='Green',bd=6,width=6
                   ,command=clear)
buttonClear.grid(row=4,column=1)

button0=Button(calculatorFrame,text='0',font=('arial',16,'bold'),fg='yellow',bg='Green',bd=6,width=6
               ,command=lambda:buttonClick('0'))
button0.grid(row=4,column=2)

buttonDiv=Button(calculatorFrame,text='/',font=('arial',16,'bold'),fg='yellow',bg='Green',bd=6,width=6,
                 command=lambda:buttonClick('/'))
